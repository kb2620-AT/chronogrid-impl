...
checking, not its independence: six of the assertions are mechanically verified in Lean 4/Mathlib
...
(hierarchy consistency). Note that the corollary establishes
