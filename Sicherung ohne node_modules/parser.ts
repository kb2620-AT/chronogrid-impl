...
import type { CTDDLDomain, DomainSemantics, DomainType, MappingClass } from 'cg-types/domain.js';
...
export function parseCTDDL(input: string | object): CTDDLDomain {
  ...
  return {
    ...
    stability: raw.stability as 'high' | 'medium' | 'low' | undefined,
    extent: {
    ...
    epoch: {
      ...
      rationale: epoch.rationale as string | undefined,
    },
    mappings: raw.mappings as CTDDLDomain['mappings'],
    scientific_dependency: raw.scientific_dependency as CTDDLDomain['scientific_dependency'],
    deprecated: raw.deprecated as boolean | undefined,
    migration_to: raw.migration_to as string | undefined,
  };
}
