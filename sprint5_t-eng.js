 ...
 */
import { safeAdd, mod, bigIntToBytesBigEndian, verifySerialization, computeMachineID, machineIdToHex, Allen, } from 'cg-engine/engine.js';
import { isLeapYear, daysInMonth, encodeGregorian, decodeGregorian, toISO8601, } from 'cg-engine/gregorian.js';
import { utcToTai, taiToUtc, lookupTaiOffset, gpsNsToTaiNs, } from 'cg-engine/mapping.js';
